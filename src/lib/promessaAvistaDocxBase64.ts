// Template .docx (verbatim) — Promessa à Vista
// Base64-encoded .docx template for "Compromisso de Compra e Venda (À Vista)"
// Contains the exact document structure required for generating
// Promessa à Vista documents using docxtemplater.
// Generated from the canonical paragraph layout — do not edit manually.
