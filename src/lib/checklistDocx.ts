...
export async function getChecklistText(data: Record<string, string>): Promise<string> {
  return extractTextFromUrl(CHECKLIST_TEMPLATE_URL, CHECKLIST_EXPECTED_BYTES, data)
}
